...
const Button = ({ text, routeFunc, includeIcon }: ButtonProps) => {
  return (
    <motion.button
        ...
        className="w-full border border-black rounded-3xl py-3 flex items-center space-x-2 hover:cursor-pointer iphone:px-3 max-sm:px-6 "
    >
        <p className="text-sm iphone:text-xs md:text-[0.9rem]">{text}</p>
